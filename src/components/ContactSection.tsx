...
export default function ContactSection({ data }: { data: any }) {
  ...
  return (
    <section id="contact" className="border-t border-[var(--color-border-main)] py-[clamp(4rem,10vh,7rem)] px-[clamp(1.5rem,6vw,6rem)] max-w-[1200px] mx-auto w-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-[auto_1fr] gap-[clamp(2rem,6vw,4rem)] items-start mt-[3rem]">
        <motion.div
        ...
        >
          <img
            ...
            className="w-[220px] h-[220px] rounded-[8px] object-cover border-2 border-[var(--color-cyan)]"
            style={{ boxShadow: '0 0 30px var(--color-cyan-glow)' }}
          />
        </motion.div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-[clamp(3rem,8vw,8rem)] items-start w-full">
          <motion.div
